...
\setlength{\topmargin}{-0.5in}      % hoặc -0.5in nếu muốn sát mép trên hơn   
\setlength{\headsep}{0.3cm}        % tăng để header cách nội dung xa hơn
\setlength{\textheight}{24cm}  % tăng lên để nội dung gần mép dưới
...
%==============================================================================
% TABLE OF CONTENTS, SYMBOLS AND ACRONYMS, FIGURES AND TABLES
\input{Section/TableOfContents}

%==============================================================================
% MEMBERS LIST AND WORKLOAD
\input{Section/Members}

%==============================================================================
% MAIN CONTENTS
\newpage
\input{Section/1. Chương 1.tex}

\newpage
\input{Section/2. Chương 2.tex}

\newpage
\input{Section/3. Chương 3.tex}

\newpage
\input{Section/4. Chương 4.tex}

\newpage
\input{Section/5. Chương 5.tex}

\newpage
\input{Section/6. Chương 6.tex}
