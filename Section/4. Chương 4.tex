...
%============================================================================
\section*{2. HTTP Server với Cookie Session}
\addcontentsline{toc}{section}{2. HTTP Server với Cookie Session}
...
\subsection*{a. Khởi tạo Server và Xử lý Đa luồng}
...
\textbf{Đoạn mã 4.1: Khởi tạo server và tạo luồng mới cho mỗi client trong \texttt{daemon/backend.py}}
...
\subsection*{b. Xử lý Yêu cầu Đăng nhập (Task 1A)}
...
\textbf{Đoạn mã 4.2: Logic xử lý đăng nhập và thiết lập cookie trong \texttt{daemon/httpadapter.py}}
...
\subsection*{c. Kiểm soát Truy cập dựa trên Cookie (Task 1B)}
...
\textbf{Đoạn mã 4.3: Logic kiểm tra cookie trong \texttt{daemon/httpadapter.py}}
...
%============================================================================
\section*{3. Ứng dụng Chat Hybrid (Client-Server kết hợp P2P)}
\addcontentsline{toc}{section}{3. Ứng dụng Chat Hybrid (Client-Server kết hợp P2P)}
...
%----------------------------------------------------------------------------
\subsection*{a. Tracker Server – Trung tâm điều phối}
...
\textbf{Đoạn mã 4.4: Khai báo biến trạng thái và định nghĩa route trong \texttt{start\_chatapp.py}}
...
%----------------------------------------------------------------------------
\subsection*{b. Peer Client – Kiến trúc Đa Server}
...
\textbf{Đoạn mã 4.5: Khởi chạy ba server song song trong \texttt{peer\_client.py}}
...
%----------------------------------------------------------------------------
\subsection*{c. Giai đoạn Client-Server: Khám phá Peer}
...
\textbf{Đoạn mã 4.6: Logic tham gia kênh và khám phá peer trong \texttt{peer\_client.py}}
...
%----------------------------------------------------------------------------
\subsection*{d. Giai đoạn Peer-to-Peer: Giao tiếp trực tiếp}
...
\textbf{Đoạn mã 4.7: Vòng lặp lắng nghe tin nhắn P2P trong \texttt{peer\_client.py}}
...
%============================================================================
\section*{4. ``Put It All Together'' – Tích hợp Hệ thống Hoàn chỉnh}
\addcontentsline{toc}{section}{4. ``Put It All Together'' – Tích hợp Hệ thống Hoàn chỉnh}
...
\subsection*{a. Tích hợp Giao diện Web và Backend Logic}
...
\begin{lstlisting}[language=Python, caption={Logic "tiêm" dữ liệu vào HTML trong \texttt{peer\_client.py}}, label={lst:inject}]
def do_GET(self):
...
\subsection*{b. Kết hợp Quản lý Session (Cookie và localStorage)}
