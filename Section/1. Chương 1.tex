...
\section*{1.1. Đặt vấn đề và mục tiêu}
...
\noindent Bài tập lớn này được thực hiện nhằm áp dụng những kiến thức lý thuyết đã học trong môn \textit{Mạng máy tính} vào việc xây dựng một hệ thống phần mềm thực tế, qua đó giúp người học củng cố và hiểu sâu hơn cách các tiến trình mạng tương tác với nhau trong môi trường phân tán.
