...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \setlength{\fboxsep}{2pt}     
        \setlength{\fboxrule}{0.5pt}   
        \fbox{\includegraphics[scale=0.23]{Picture/login3acc.png}}
    ...
    \begin{figure}[H]
        ...
        \setlength{\fboxsep}{2pt}     
        \setlength{\fboxrule}{0.5pt}   
        \fbox{\includegraphics[scale=0.23]{Picture/chatui.png}}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \setlength{\fboxsep}{2pt}     
        \setlength{\fboxrule}{0.5pt}   
        \fbox{\includegraphics[scale=0.23]{Picture/3general.png}}
    ...
    \textbf{Kết quả: } Nhóm \#broadcast là nhóm mặc định tất cả các Peer khi đăng nhập, có vai trò là nhóm chat chung và có vai trò broadcast, các tin nhắn dạng broadcast sẽ được truyền đến bất kì nhóm chat nào, bất kì đoạn chat cá nhân nào.
        ...
        \setlength{\fboxsep}{2pt}     
        \setlength{\fboxrule}{0.5pt}   
        \fbox{\includegraphics[scale=0.23]{Picture/3broadcast.png}}
    ...
    \begin{figure}[H]
        ...
        \setlength{\fboxsep}{2pt}     
        \setlength{\fboxrule}{0.5pt}   
        \fbox{\includegraphics[scale=0.23]{Picture/1broad2gen.png}}
    ...
    \begin{figure}[H]
        ...
        \setlength{\fboxsep}{2pt}     
        \setlength{\fboxrule}{0.5pt}   
        \fbox{\includegraphics[scale=0.23]{Picture/alicebob.png}}
    ...
    \begin{figure}[H]
        ...
        \setlength{\fboxsep}{2pt}     
        \setlength{\fboxrule}{0.5pt}   
        \fbox{\includegraphics[scale=0.23]{Picture/johnbroadtoprivate.png}}
    ...
    \begin{figure}[H]
        ...
        \setlength{\fboxsep}{2pt}     
        \setlength{\fboxrule}{0.5pt}   
        \fbox{\includegraphics[scale=0.23]{Picture/CN04.png}}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            ...
            \setlength{\fboxsep}{2pt}
            \setlength{\fboxrule}{0.5pt}
            \fbox{\includegraphics[scale=0.5]{Picture/loginAPIPM.png}}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            ...
            \setlength{\fboxsep}{2pt}
            \setlength{\fboxrule}{0.5pt}
            \fbox{\includegraphics[scale=0.5]{Picture/registerAPIPM.png}}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.6]{Picture/submitinfoAPIPM.png}}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.6]{Picture/addlistAPIPM.png}}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.4]{Picture/getlistAPIPM.png}}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.4]{Picture/statusAPIPM.png}}
